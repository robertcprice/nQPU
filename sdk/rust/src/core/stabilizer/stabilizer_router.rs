...
impl BenchmarkResults {
    ...
    pub fn print_summary(&self) {
        ...
        for point in &self.points {
            let winner = if point.ratio > 1.1 {
                "GPU ✅"
            } else if point.ratio < 0.9 {
                "CPU ✅"
            } else {
                "Tie"
            };
            println!(
                "{:<10} {:>12.2} {:>12.2} {:>10.2}x {:>10}",
                point.num_qubits, point.cpu_time_ms, point.gpu_time_ms, point.ratio, winner
            );
        }
...
impl AutoStabilizer {
    ...
    pub fn run_full_benchmark(&mut self) -> BenchmarkResults {
        ...
        let cpu_info = std::env::var("HOSTNAME").unwrap_or_else(|_| "Apple Silicon".to_string());
        ...
        let gates: Vec<_> = (0..num_gates)
            .map(|i| {
                ...
                match i % 4 {
                    ...
                    2 => crate::metal_stabilizer::StabilizerGate::CX {
                        control: q,
                        target: q2,
                    },
                    _ => crate::metal_stabilizer::StabilizerGate::CZ {
                        qubit1: q,
                        qubit2: q2,
                    },
                }
