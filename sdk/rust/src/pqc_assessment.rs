...
impl fmt::Display for QuantumAttackEstimate {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(f, "  Physical qubits (surface code): {}", self.surface_code_qubits)?;
...
impl PqcComparisonMatrix {
    ...
    pub fn at_risk(&self) -> Vec<&ThreatAssessment> {
        self.assessments
            .iter()
            .filter(|a| a.threat_level == ThreatLevel::Critical || a.threat_level == ThreatLevel::High)
            .collect()
    }
...
impl PqcConfig {
    ...
    pub fn total_physical_qubits(&self, logical_qubits: usize) -> usize {
        ...
        let factory_physical =
            self.magic_state_factory_count * 16 * self.surface_code_distance * self.surface_code_distance;
...
pub fn assess_algorithm(
    ...
    match algorithm {
        ...
        CryptoAlgorithm::ECC { curve_bits } => {
            ...
            let estimate =
                shor_to_attack_estimate(&format!("ECC-{}", curve_bits), &shor, config);
        ...
        CryptoAlgorithm::DH { key_bits } => {
            ...
            let estimate =
                shor_to_attack_estimate(&format!("DH-{}", key_bits), &shor, config);
            ThreatAssessment {
                algorithm: algorithm.clone(),
        ...
        CryptoAlgorithm::DSA { key_bits } => {
            let shor = shor_dh_dsa_estimate(*key_bits);
            let estimate =
                shor_to_attack_estimate(&format!("DSA-{}", key_bits), &shor, config);
            ThreatAssessment {
                algorithm: algorithm.clone(),
                classical_security_bits: dh_classical_security(*key_bits),
                quantum_security_bits: 0,
...
pub fn build_comparison_matrix(
    ...
    let assessments: Vec<ThreatAssessment> =
        algorithms.iter().map(|a| assess_algorithm(a, config)).collect();
...
pub fn build_comprehensive_matrix(config: &PqcConfig) -> PqcComparisonMatrix {
    let algorithms = vec![
        ...
        // NIST PQC
        CryptoAlgorithm::MLKEM { parameter_set: MLKEMParams::ML512 },
        CryptoAlgorithm::MLKEM { parameter_set: MLKEMParams::ML768 },
        CryptoAlgorithm::MLKEM { parameter_set: MLKEMParams::ML1024 },
        CryptoAlgorithm::MLDSA { parameter_set: MLDSAParams::ML44 },
        CryptoAlgorithm::MLDSA { parameter_set: MLDSAParams::ML65 },
        CryptoAlgorithm::MLDSA { parameter_set: MLDSAParams::ML87 },
        CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_128s },
        CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_256f },
        CryptoAlgorithm::HQC { parameter_set: HQCParams::HQC128 },
        CryptoAlgorithm::HQC { parameter_set: HQCParams::HQC256 },
        CryptoAlgorithm::NTRU { parameter_set: NTRUParams::NTRU677 },
        CryptoAlgorithm::BIKE { parameter_set: BIKEParams::BIKE3 },
        CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC6688128 },
    ];
...
fn hardware_roadmap() -> Vec<HardwareMilestone> {
    vec![
        HardwareMilestone { year: 2025, logical_qubits: 10 },
        HardwareMilestone { year: 2027, logical_qubits: 100 },
        HardwareMilestone { year: 2029, logical_qubits: 1_000 },
        HardwareMilestone { year: 2031, logical_qubits: 4_000 },
        HardwareMilestone { year: 2033, logical_qubits: 10_000 },
        HardwareMilestone { year: 2035, logical_qubits: 20_000 },
        HardwareMilestone { year: 2040, logical_qubits: 100_000 },
        HardwareMilestone { year: 2045, logical_qubits: 1_000_000 },
    ]
}
...
mod tests {
    ...
    fn test_timeline_rsa_breakable_estimate_year() {
        let config = default_config();
        let break_year =
            estimate_break_year(&CryptoAlgorithm::RSA { key_bits: 2048 }, &config);
    ...
    fn test_timeline_aes_256_safe_indefinitely() {
        let config = default_config();
        let break_year =
            estimate_break_year(&CryptoAlgorithm::AES { key_bits: 256 }, &config);
    ...
    fn test_all_pqc_algorithms_assessment_runs() {
        ...
        let algorithms = vec![
            ...
            CryptoAlgorithm::MLDSA { parameter_set: MLDSAParams::ML65 },
            CryptoAlgorithm::MLDSA { parameter_set: MLDSAParams::ML87 },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_128f },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_128s },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_192f },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_192s },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_256f },
            CryptoAlgorithm::SLHDSA { parameter_set: SLHDSAParams::SHA2_256s },
            CryptoAlgorithm::HQC { parameter_set: HQCParams::HQC128 },
            CryptoAlgorithm::HQC { parameter_set: HQCParams::HQC192 },
            CryptoAlgorithm::HQC { parameter_set: HQCParams::HQC256 },
            CryptoAlgorithm::NTRU { parameter_set: NTRUParams::NTRU509 },
            CryptoAlgorithm::NTRU { parameter_set: NTRUParams::NTRU677 },
            CryptoAlgorithm::NTRU { parameter_set: NTRUParams::NTRU821 },
            CryptoAlgorithm::BIKE { parameter_set: BIKEParams::BIKE1 },
            CryptoAlgorithm::BIKE { parameter_set: BIKEParams::BIKE3 },
            CryptoAlgorithm::BIKE { parameter_set: BIKEParams::BIKE5 },
            CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC348864 },
            CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC460896 },
            CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC6688128 },
            CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC6960119 },
            CryptoAlgorithm::ClassicMcEliece { parameter_set: McElieceParams::MC8192128 },
        ];
        ...
        for algo in &algorithms {
            ...
            assert!(
                assessment.classical_security_bits > 0
                    || assessment.quantum_security_bits == 0,
    ...
    fn test_threat_timeline_projection() {
        ...
        assert!(
            y2040.algorithms_at_risk.iter().any(|a| a.contains("RSA-2048")),
