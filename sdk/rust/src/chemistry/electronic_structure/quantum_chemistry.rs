...
use crate::vqe::{Hamiltonian, PauliOperator, PauliTerm};
use crate::C64;
    ...
    pub fn build_hamiltonian(
        ...
        for p in 0..n_modes {
            for q in 0..n_modes {
                ...
                if p == q {
                    ...
                    terms.push(PauliTerm::new(vec![PauliOperator::I(0)], h_pq * 0.5));
                    terms.push(PauliTerm::new(vec![PauliOperator::Z(p)], -h_pq * 0.5));
                } else {
        ...
        for p in 0..n_modes {
            for q in 0..n_modes {
                ...
                // n_p n_q type terms
                terms.push(PauliTerm::new(vec![PauliOperator::I(0)], h_pqpq * 0.25));
                terms.push(PauliTerm::new(vec![PauliOperator::Z(p)], -h_pqpq * 0.25));
                terms.push(PauliTerm::new(vec![PauliOperator::Z(q)], -h_pqpq * 0.25));
            ...
            for j in (i + 1)..n_occ {
                for a in n_occ..self.n_spin_orbitals {
                    for b in (a + 1)..self.n_spin_orbitals {
                        if param_idx < params.len() {
                            gates.extend(self.double_excitation_circuit(
                                i,
                                j,
                                a,
                                b,
...
pub mod molecules {
    ...
    pub fn h2_sto3g() -> MolecularData {
        ...
        let terms = vec![
            ...
            PauliTerm::new(vec![PauliOperator::Z(0), PauliOperator::Z(1)], 0.1686),
            PauliTerm::new(vec![PauliOperator::Z(0), PauliOperator::Z(2)], 0.1205),
            PauliTerm::new(vec![PauliOperator::Z(0), PauliOperator::Z(3)], 0.1659),
            PauliTerm::new(vec![PauliOperator::Z(1), PauliOperator::Z(2)], 0.1659),
            PauliTerm::new(vec![PauliOperator::Z(1), PauliOperator::Z(3)], 0.1205),
            PauliTerm::new(vec![PauliOperator::Z(2), PauliOperator::Z(3)], 0.1744),
            PauliTerm::new(
                vec![
                    PauliOperator::X(0),
                    PauliOperator::X(1),
    ...
    pub fn heh_plus_sto3g() -> MolecularData {
        ...
        let terms = vec![
            ...
            PauliTerm::new(vec![PauliOperator::Z(0), PauliOperator::Z(1)], 0.1817),
            PauliTerm::new(vec![PauliOperator::Z(0), PauliOperator::Z(2)], 0.1156),
            PauliTerm::new(vec![PauliOperator::Z(1), PauliOperator::Z(3)], 0.1156),
            PauliTerm::new(vec![PauliOperator::Z(2), PauliOperator::Z(3)], 0.1915),
        ];
...
impl ActiveSpaceSelector {
    ...
    pub fn select(&self, n_active_electrons: usize, n_active_orbitals: usize) -> ActiveSpace {
        ...
        let active_orbitals: Vec<usize> = (n_frozen..(n_frozen + n_active_orbitals)).collect();
...
mod tests {
    ...
    fn test_single_excitation() {
        ...
        let has_ry = circuit
            .iter()
            .any(|g| matches!(g.gate_type, GateType::Ry(_)));
        assert!(has_ry);
    }
