...
impl PerfDashboard {
    ...
    pub fn update(&mut self, gates_per_sec: f64, memory_mb: f64, qubits: usize, depth: usize, backend: &str) {
    ...
    pub fn render(&self) -> Vec<String> {
        ...
        lines.push(format!("{}╔══════════════════════════════════════╗{}", b, r));
        lines.push(format!("{}║     nQPU-Metal Performance           ║{}", b, r));
        lines.push(format!("{}╠══════════════════════════════════════╣{}", b, r));

        let mhz = self.gates_per_sec / 1_000_000.0;
        let color = if mhz > 50.0 { ansi::BRIGHT_GREEN }
                   else if mhz > 20.0 { ansi::BRIGHT_YELLOW }
                   else { ansi::BRIGHT_RED };

        lines.push(format!("{}║{} Throughput: {}{:>10.2} MHz{}     {}║{}", b, r, color, mhz, r, b, r));
        lines.push(format!("{}║{} Qubits:     {}{:>10}{}          {}║{}", b, r, ansi::BRIGHT_CYAN, self.qubits, r, b, r));
        lines.push(format!("{}║{} Depth:      {}{:>10}{}          {}║{}", b, r, ansi::BRIGHT_CYAN, self.depth, r, b, r));
        lines.push(format!("{}║{} Memory:     {}{:>10.1} MB{}       {}║{}", b, r, ansi::BRIGHT_MAGENTA, self.memory_mb, r, b, r));
        lines.push(format!("{}║{} Backend:    {}{:>10}{}          {}║{}", b, r, ansi::BRIGHT_BLUE, self.backend, r, b, r));
        lines.push(format!("{}╚══════════════════════════════════════╝{}", b, r));
...
impl QuantumTUI {
    ...
    pub fn render(&mut self) {
        ...
        // Title
        println!("{}{}╔═══════════════════════════════════════════════════════════════════╗{}", ansi::BOLD, ansi::BG_BLUE, ansi::RESET);
        println!("{}{}║             {}nQPU-Metal Quantum Simulator TUI v2.0{}               {}║{}", ansi::BOLD, ansi::BG_BLUE, ansi::BRIGHT_WHITE, ansi::RESET, ansi::BG_BLUE, ansi::RESET);
        println!("{}{}╚═══════════════════════════════════════════════════════════════════╝{}", ansi::BOLD, ansi::BG_BLUE, ansi::RESET);
        println!();
        ...
        // Bloch Sphere
        println!("{}{} Bloch Sphere (3D){}", ansi::BOLD, ansi::CYAN, ansi::RESET);
        ...
        // Histogram
        println!("{}{} State Probabilities{}", ansi::BOLD, ansi::CYAN, ansi::RESET);
        ...
        // Circuit
        println!("{}{} Circuit Diagram{}", ansi::BOLD, ansi::CYAN, ansi::RESET);
        ...
        // Controls
        println!("{}[q]{}uit  {}[r]{}otate  {}[space]{}step", ansi::GREEN, ansi::RESET, ansi::GREEN, ansi::RESET, ansi::GREEN, ansi::RESET);
    ...
    pub fn tick(&mut self) {
        ...
        self.dashboard.update(
            ...
            10,
            50,
            if self.frame % 100 < 50 { "CPU (NEON)" } else { "GPU (Metal)" }
        );
...
pub fn run_tui_demo() {
    println!("{}{}Starting nQPU-Metal TUI...{}", ansi::CLEAR, ansi::HOME, ansi::RESET);
    println!();
    println!("Features:");
    println!("  {}•{} 3D Bloch sphere visualization", ansi::GREEN, ansi::RESET);
    println!("  {}•{} Real-time performance dashboard", ansi::GREEN, ansi::RESET);
