...
impl fmt::Display for FactoryResult {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(
            f,
            "Raw states consumed:     {}",
            self.total_raw_states_consumed
        )?;
        writeln!(f, "Physical qubits:         {}", self.total_physical_qubits)?;
        writeln!(
            f,
            "Distillation cycles:     {}",
            self.distillation_time_cycles
        )?;
...
impl fmt::Display for ResourceEstimate {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        writeln!(
            f,
            "Factory patches:      {}",
            self.factory_footprint_patches
        )?;
        Ok(())
    }
}
    ...
    pub fn estimate_resources(
        ...
        for protocol in &protocols {
            ...
            for levels in 1..=max_levels {
                let factory =
                    MagicStateFactory::new(protocol.clone(), levels, code_distance, physical_error);
                let result = factory.distill();
        ...
        let total_time_us = rec_result.distillation_time_cycles as f64 * cycle_time_us;
...
impl CascadeFactory {
    ...
    pub fn new(levels: Vec<(DistillationProtocol, usize)>, physical_error_rate: f64) -> Self {
...
mod tests {
    ...
    fn test_single_level_distillation() {
        let factory = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 1, 15, 1e-3);
        let result = factory.distill();
    ...
    fn test_multi_level_distillation() {
        let factory = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 2, 17, 1e-3);
        let result = factory.distill();
    ...
    fn test_physical_qubit_count() {
        let factory = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 1, 7, 1e-3);
    ...
    fn test_distillation_time() {
        let factory = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 1, 11, 1e-3);
        let result = factory.distill();
    ...
    fn test_level_details() {
        let factory = MagicStateFactory::new(DistillationProtocol::TwentyToFour, 3, 13, 1e-2);
        let result = factory.distill();
    ...
    fn test_error_threshold() {
        ...
        let factory_ok = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 1, 7, 0.001);
    ...
    fn test_litinski_compact_efficiency() {
        ...
        let standard =
            MagicStateFactory::new(DistillationProtocol::FifteenToOne, 2, distance, p_in);
        let compact =
            MagicStateFactory::new(DistillationProtocol::LitinskiCompact, 2, distance, p_in);
    ...
    fn test_very_low_physical_error() {
        ...
        let factory = MagicStateFactory::new(DistillationProtocol::FifteenToOne, 1, 7, 1e-4);
        let result = factory.distill();
