...
impl UmaDispatcher {
    ...
    pub fn decide(&self, analysis: &GateAnalysis) -> DispatchDecision {
        ...
        if n_touched > effective_threshold {
            ...
            let gpu_cost_ns = gpu_overhead_ns + (state_dim as f64 * 0.5 / cm.gpu_throughput_factor);
            return DispatchDecision {
    ...
    pub fn find_concurrent_pairs(&self, gates: &[Gate], num_qubits: usize) -> Vec<(usize, usize)> {
